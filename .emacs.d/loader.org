...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Refer to past buffers as existing ones
  ...
  (global-set-key (kbd "C-S-o") 'ido-find-file-other-window)
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (progn
      ...
      ;; stop prompting for confirmation for every org-babel eval
...
* Look and feel
**Note:** Some of these settings, such as font and color scheme, are set in
