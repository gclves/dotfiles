...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key org-agenda-mode-map (kbd "s-M-i") 'org-agenda-clock-in)
  (define-key org-agenda-mode-map (kbd "s-M-o") 'org-agenda-clock-out)

  (define-key org-mode-map (kbd "s-M-i") 'org-clock-in)
  (define-key org-mode-map (kbd "s-M-o") 'org-clock-out)
