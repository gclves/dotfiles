...
Leuven is the best color theme ever made.
#+BEGIN_SRC emacs-lisp
  (use-package leuven-theme
    :config
    (load-theme 'leuven t)
    ; remove the gigantic org-agenda headers
...
#+BEGIN_SRC emacs-lisp
  (use-package helm
    ...
    :config
    (progn
      (global-set-key (kbd "C-c h") 'helm-comand-prefix)
...
** TODO Autocomplete and snippets
#+BEGIN_SRC emacs-lisp
